...
var PackeryComponent = createReactClass({
  masonry: false,
  erd: undefined,
  ...
  initializeMasonry: function(force) {
    if (!this.masonry || force) {
      this.masonry = new Packery(this.masonryContainer, this.props.options);
  ...
  diffDomChildren: function() {
    ...
    var knownChildrenStillAttached = this.latestKnownDomChildren.filter(
      function(element) {
        /*
     ...
     */
    var removed = knownChildrenStillAttached.filter(function(
      attachedKnownChild
    ) {
  ...
  imagesLoaded: function() {
    ...
    var imgLoad = imagesloaded(
      ...
      this.props.imagesLoadedOptions
    ).on(event, handler);
...
module.exports.default = PackeryComponent;
